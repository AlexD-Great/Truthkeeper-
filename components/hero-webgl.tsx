...
export const Hero3DWebGL = () => {
  const titleWords = "TruthKeeper".split(" ")
  const subtitle = "Check the news. Store the proof. Forever on Filecoin."
  ...
  return (
    <div className="h-svh bg-black relative overflow-hidden">
      ...
      <div className="h-svh uppercase items-center w-full absolute z-60 pointer-events-none px-10 flex justify-center flex-col">
        <div
          className={subtitleVisible ? "fade-in mb-4" : "mb-4"}
          style={{
            animationDelay: "0s",
            opacity: subtitleVisible ? undefined : 0,
          }}
        >
          <span className="border border-red-500/60 text-red-400 text-xs md:text-sm font-geist px-4 py-1.5 rounded-full tracking-widest normal-case">
            AI-Powered Fact-Checking on Filecoin
          </span>
        </div>
        ...
        <div
          className={`normal-case flex flex-col sm:flex-row gap-4 mt-8 pointer-events-auto ${subtitleVisible ? "fade-in-subtitle" : ""}`}
          style={{
        ...
        >
          <a
            href="#how-it-works"
            className="bg-red-500 hover:bg-red-600 text-white font-geist text-sm md:text-base px-8 py-3 rounded-md transition-colors duration-200 text-center"
          >
            See How It Works
          </a>
          <a
            href="#filecoin"
            className="border border-red-500 text-red-400 hover:bg-red-500/10 font-geist text-sm md:text-base px-8 py-3 rounded-md transition-colors duration-200 text-center"
          >
